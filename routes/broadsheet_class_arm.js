...
getschoolsubject = async  (school_id, class_arm) => {
	var arm = await connect.ClassArm.findOne({where: {school_id:school_id, id:class_arm}});
    const file = {}
	if(arm){
...
exports.getbroadsheet = async function (req, res) {
    ...
    var academic = await connect.AcademicSession.findAll({where:{class_arm_id:req.query.class_arm_id, 
