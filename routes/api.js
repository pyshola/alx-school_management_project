...
//router.get('/feesanalysis', setRequestTime, auth, Teacher.poststudentschoolbill)
...
router.post('/remarksetting', setRequestTime, auth, Subject.postremarksetting)
router.get('/remarksetting', setRequestTime, auth, Subject.getremarksetting)
...
router.get('/studentreportcardaccess', setRequestTime, auth, Subject.getstudentreportcardaccess)
router.post('/publishstudentresult', setRequestTime, auth, Subject.postpublishstudentresult)
