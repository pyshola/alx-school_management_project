...
exports.Promotion = model.Promotion_table(sequelize)

exports.Remark = model.Remark_table(sequelize)
exports.Signature = model.Signature_table(sequelize)
exports.StudentReportCard = model.StudentReportCard_table(sequelize)