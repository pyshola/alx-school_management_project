...
$(document).ready(function(){
	...
	if (token == null) {
		...
		<span class="pcoded-mtext" data-i18n="nav.dash.main">Dashboard</span><span class="pcoded-mcaret"></span></a></li>\
			<li class="active"><a href="https://alxproject.virilesoftware.com/eportal/'+payload.username +'/students"><span class="pcoded-micon"><i class="icon ion-ios-people"></i></span>\
	...
	if(payload.position == 'Owner')
	{
		var htmlss = '<li><a href="javascript:;"><i class="ti-email"></i>My Message</a></li>\
